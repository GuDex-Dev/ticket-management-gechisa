...
import { useRegisterAdministratorForm } from "./hooks";

function RegisterAdministratorPage() {
  const { form, onSubmit } = useRegisterAdministratorForm();
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Contraseña <span className="text-xs text-red-500">(*)</span></FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Ciudad <span className="text-xs text-red-500">(*)</span></FormLabel>
                  <FormControl>
...
export default RegisterAdministratorPage;
